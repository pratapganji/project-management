...
(ID, ROLE_NAME, TABLE_NAME, PERMISSION, CREATE_DATE)
VALUES ((SELECT NVL(MAX(ID),0)+1 FROM A167969NURAREC.ROLE_TABLE_PERMISSION),
'OLYMPUS_READ_WRITE',
'OM_NURAFLOW_EXCEPTION_CLASSIFICATION',
'SELECT',
SYSTIMESTAMP);
...
(ID, ROLE_NAME, TABLE_NAME, COLUMN_NAME, PERMISSION, CREATE_DATE)
VALUES ((SELECT NVL(MAX(ID),0)+1 FROM A167969NURAREC.ROLE_COLUMN_PERMISSION),
'OLYMPUS_READ_WRITE',
'OM_NURAFLOW_EXCEPTION_CLASSIFICATION',
'*',
'SELECT',
...
WHERE ROLE_NAME = 'OLYMPUS_READ_WRITE'
  AND TABLE_NAME = 'OM_NURAFLOW_EXCEPTION_CLASSIFICATION';
...
DELETE FROM A167969NURAREC.ROLE_COLUMN_PERMISSION
WHERE ID IN (7, 8)
  AND ROLE_NAME = 'OLYMPUS_READ_WRITE'
  AND TABLE_NAME = 'OM_NURAFLOW_JIRA_TRACKING';

DELETE FROM A167969NURAREC.ROLE_TABLE_PERMISSION
WHERE ID = 6
  AND ROLE_NAME = 'OLYMPUS_READ_WRITE'
  AND TABLE_NAME = 'OM_NURAFLOW_JIRA_TRACKING'
